...
const Icons = styled(Box) (({theme}) => ({display: 'none', alignItems: 'center',
gap: '20px', [theme.breakpoints.up('sm')]:{display: 'flex'}}))

const UserBox = styled(Box) (({theme}) => ({display: 'flex', alignItems: 'center',
gap: '10px', [theme.breakpoints.up('sm')]:{display: 'none'}}))
...
const Navbar = () => {
  ...
  return (
    <AppBar position='sticky'>
        <StyledToolbar>
        <Typography variant='h6' sx={{display: {xs:'none', sm:'block'}}}>TOMI DEV</Typography>
       ...
       <UserBox onClick={e=> setOpen(true)}>
        ...
        <Typography variant='span'>Mary</Typography>
       </UserBox>
        </StyledToolbar>
